...
//         fullDescription: 'This project was developed as my final project for Web Development class. The goal was to create a centralized platform where students could easily find events happening on campus, RSVP, and get reminders. I designed the entire user flow in Figma first, conducting user interviews with 15 students to understand their pain points with existing event discovery methods. The app features a filterable event calendar, category-based browsing, user authentication, and persistent data using localStorage. One challenge was implementing the calendar view to be both functional and visually appealing across devices. I learned a lot about responsive design patterns and JavaScript date manipulation.',
//         tech: ['REACT JS', 'TAILWIND CSS', 'FRAMER MOTION', 'Responsive Design'],
//         features: ['Interactive event calendar', 'RSVP functionality', 'Event filtering by category', 'User profiles', 'Mobile-responsive design'],
//         challenges: 'The biggest challenge was creating a performant calendar view that worked smoothly on mobile devices while maintaining a clean, intuitive interface.',
//         outcome: 'Received an A+ on the project and positive feedback from classmates who actually started using it to track campus events.'
//     },
//     {
//         title: 'Weather Forecast Dashboard',
//         description: 'Clean, minimalist weather application with location-based forecasts, animated weather icons, and 7-day predictions.',
//         fullDescription: 'I built this weather dashboard to practice working with APIs and data visualization. The app uses the OpenWeather API to fetch real-time weather data and forecasts. I focused heavily on the user experience, creating custom animated weather icons using pure CSS and implementing smooth transitions between different weather states. The design is minimalist, putting the weather information front and center without unnecessary clutter. I also implemented geolocation to automatically show weather for the user\'s current location, with the ability to search for any city worldwide.',
//         tech: ['React', 'OpenWeather API', 'CSS3 Animations', 'Geolocation API', 'Responsive Design'],
//         features: ['Real-time weather data', 'Location-based forecasts', 'Animated weather icons', '7-day forecast', 'City search'],
//         challenges: 'Handling API rate limits and creating fallback states for when weather data is unavailable or slow to load.',
//         outcome: 'Successfully deployed and shared with friends who appreciated the clean interface and accurate forecasts.'
//     },
//     {
//         title: 'Portfolio Redesign for Local Artist',
//         description: 'Complete UI/UX redesign and development of a portfolio website showcasing artwork with smooth transitions and gallery features.',
//         fullDescription: 'A local artist reached out for help redesigning their outdated portfolio website. I conducted a full UX audit of their existing site, identified pain points, and proposed a modern redesign that would showcase their artwork beautifully. The process started with user research, understanding who visits artist portfolios and what they look for. I created wireframes and high-fidelity mockups in Figma, iterating based on the artist\'s feedback. The final site features a full-screen gallery with smooth transitions, categorized artwork, an about section, and a contact form. I optimized all images for web performance while maintaining visual quality.',
//         tech: ['Figma', 'HTML5', 'CSS3', 'JavaScript', 'Image Optimization'],
//         features: ['Full-screen image gallery', 'Smooth transitions', 'Category filtering', 'Lightbox view', 'Contact form'],
//         challenges: 'Balancing image quality with page load performance, especially for high-resolution artwork images.',
//         outcome: 'The artist reported increased engagement and several commission requests through the new website.'
//     },
//     {
//         title: 'Task Tracker Pro',
//         description: 'Productivity app with drag-and-drop functionality, priority levels, and progress tracking for personal and team tasks.',
//         fullDescription: 'This productivity app was born from my own frustration with overly complicated task managers. I wanted something simple yet powerful, focusing on the core features that actually help people get things done. The app uses the HTML5 Drag and Drop API to allow users to organize tasks visually, moving them between different status columns (To Do, In Progress, Done). Each task can have priority levels, due dates, and tags. I implemented a clean visual hierarchy using CSS Grid for the layout and custom JavaScript for the drag-and-drop logic. The app stores all data locally, ensuring privacy and offline functionality.',
//         tech: ['Vanilla JavaScript', 'HTML5 Drag & Drop API', 'CSS Grid', 'LocalStorage', 'Responsive Design'],
//         features: ['Drag-and-drop interface', 'Priority levels', 'Task categorization', 'Progress tracking', 'Local data persistence'],
//         challenges: 'Implementing smooth drag-and-drop interactions that work well on both desktop and touch devices.',
//         outcome: 'Currently using it daily for my own task management and shared with classmates who found it helpful.'
//     }
// ];
